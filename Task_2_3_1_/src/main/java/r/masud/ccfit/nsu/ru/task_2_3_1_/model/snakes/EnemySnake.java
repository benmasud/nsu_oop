 ...
 */
public abstract class EnemySnake {
    ...
    public int score;
    public EnemySnake.Direction currentDirection;
     ...
     */
    public EnemySnake(GameField gameField, Food food, Walls walls) {
    ...
    public void movingNext() {
        EnemySnake.Direction direction = getRandomDirection(directions());
        if (direction != null) {
            switch (direction) {
     ...
     */
    List<EnemySnake.Direction> directions() {

        List<EnemySnake.Direction> directions = new ArrayList<>();

        EnemySnake.Direction randomDirection;

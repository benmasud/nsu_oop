package r.masud.ccfit.nsu.ru.task_2_3_1_.controller;
import javafx.event.ActionEvent;
import javafx.event.EventHandler;
import javafx.scene.control.Button;
import javafx.scene.control.Label;
import javafx.scene.input.KeyCode;
import r.masud.ccfit.nsu.ru.task_2_3_1_.SnakeGame.Direction;
    ...
    public Label handleLevelButton(Button buttonLevel, Button buttonLevel2, Button buttonLevel3) {
        ...
        buttonLevel.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                level.setText("You've selected level 1");
            }
        });
        ...
        buttonLevel2.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                level.setText("You've selected level 2");
            }
        });
        ...
        buttonLevel3.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                level.setText("You've selected level 3");
            }
        });
        return level;
    }
